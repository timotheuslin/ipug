...
try:
    ...
    #BUGBUG: beware of the vulnerable privilege propagation when importing a local python file.
...
def setup_codetree(codetree):
    ...
    def _get_code(node):
        ...
        if not os.path.exists(dot_git):
            ...
            if r[0]:
                return r
        r = run(['git', 'checkout', sig], local_dir, verbose=True)
        if r[0]:
            return r
